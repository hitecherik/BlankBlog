<?php
	...
	include "header.php";
?>
	<h2>"<?php echo $title; ?>" - post creation</h2>
	<p>
		<?php
			if($qresult){
				echo 'The post was successful.';
			} else {
				echo 'The post was not successful.</p><p>Ty reloading this page and trying again, or check if you have entered your username and password correctly.';
			}
		?>
	</p>
